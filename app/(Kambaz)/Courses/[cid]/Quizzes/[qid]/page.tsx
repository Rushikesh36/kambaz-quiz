...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
    const state: any = useSelector((s: any) => s);// eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    const handleSave = async () => {
        ...
        if (isNew) {
            const created = await client.createQuestion(String(qid), data);
